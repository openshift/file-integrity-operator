...
e2e: namespace operator-sdk
	...
	unset GOFLAGS && $(GOPATH)/bin/operator-sdk test local ./tests/e2e --image "$(RELATED_IMAGE_OPERATOR_PATH)" --operator-namespace "$(NAMESPACE)" --go-test-flags "$(E2E_GO_TEST_FLAGS)"
