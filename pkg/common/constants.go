...
const (
	...
	// AideDatabaseReinitConfigMapKey tells us if a node need to be removed from the annotation
	AideDatabaseReinitConfigMapKey = "file-integrity.openshift.io/remove-node"
	...
	UpdateConflictConfigMapSuffix      = "-update-conflict-cm"
